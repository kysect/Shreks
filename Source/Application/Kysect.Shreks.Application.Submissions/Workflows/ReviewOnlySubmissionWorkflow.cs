...
public class ReviewOnlySubmissionWorkflow : ISubmissionWorkflow
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var message = UserCommandProcessingMessage.ReviewRatedSubmission(submission.Points?.Value ?? 0);
    ...
    {
        await _permissionValidator.EnsureSubmissionMentorAsync(issuerId, submissionId, cancellationToken);
        var submission = await ExecuteSubmissionCommandAsync(submissionId, cancellationToken, x => x.Rate(0, 0));
