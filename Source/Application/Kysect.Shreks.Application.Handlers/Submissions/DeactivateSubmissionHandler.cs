...
using static Kysect.Shreks.Application.Abstractions.Submissions.Commands.DeactivateSubmission;

namespace Kysect.Shreks.Application.Handlers.Submissions;

internal class DeactivateSubmissionHandler : SubmissionStateHandlerBase<Command, Response>
{
    public DeactivateSubmissionHandler(IShreksDatabaseContext context, IMapper mapper) : base(context, mapper) { }
