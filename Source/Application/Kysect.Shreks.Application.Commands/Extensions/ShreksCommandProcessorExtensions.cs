...
{
    public static async Task<BaseShreksCommandResult> ProcessBaseCommandSafe(
        this IShreksCommandProcessor shreksCommandProcessor,
        ...
        CancellationToken cancellationToken)
    {
        try
        {
            return await ProcessBaseCommand(shreksCommandProcessor, command, cancellationToken);
        }
        catch (Exception e)
        {
    ...
    private static async Task<BaseShreksCommandResult> ProcessBaseCommand(
        IShreksCommandProcessor shreksCommandProcessor,
        IShreksCommand command,
        CancellationToken cancellationToken)
    {
        switch (command)
