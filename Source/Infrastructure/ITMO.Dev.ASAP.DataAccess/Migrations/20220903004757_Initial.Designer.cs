...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ITMO.Dev.ASAP.Core.Queue.Evaluators.SubmissionEvaluator", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ITMO.Dev.ASAP.Core.Queue.Filters.SubmissionQueueFilter", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ITMO.Dev.ASAP.Core.Queue.SubmissionQueue", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ITMO.Dev.ASAP.Core.Queue.Evaluators.AssignmentDeadlineStateEvaluator", b =>
                {
                    b.HasBaseType("ITMO.Dev.ASAP.Core.Queue.Evaluators.SubmissionEvaluator");

                    b.HasDiscriminator().HasValue("AssignmentDeadlineStateEvaluator");
                });

            modelBuilder.Entity("ITMO.Dev.ASAP.Core.Queue.Evaluators.SubmissionDateTimeEvaluator", b =>
                {
                    b.HasBaseType("ITMO.Dev.ASAP.Core.Queue.Evaluators.SubmissionEvaluator");
            ...
            modelBuilder.Entity("ITMO.Dev.ASAP.Core.Queue.Filters.AssignmentGroupFilter", b =>
                {
                    b.HasBaseType("ITMO.Dev.ASAP.Core.Queue.Filters.SubmissionQueueFilter");

                    b.HasDiscriminator().HasValue("AssignmentGroupFilter");
                });

            modelBuilder.Entity("ITMO.Dev.ASAP.Core.Queue.Filters.GroupQueueFilter", b =>
                {
                    b.HasBaseType("ITMO.Dev.ASAP.Core.Queue.Filters.SubmissionQueueFilter");
            ...
            modelBuilder.Entity("ITMO.Dev.ASAP.Core.Queue.Filters.SubjectCoursesFilter", b =>
                {
                    b.HasBaseType("ITMO.Dev.ASAP.Core.Queue.Filters.SubmissionQueueFilter");
            ...
            modelBuilder.Entity("ITMO.Dev.ASAP.Core.Queue.Filters.SubmissionStateFilter", b =>
                {
                    b.HasBaseType("ITMO.Dev.ASAP.Core.Queue.Filters.SubmissionQueueFilter");
            ...
            modelBuilder.Entity("AssignmentAssignmentGroupFilter", b =>
                {
                    b.HasOne("ITMO.Dev.ASAP.Core.Study.Assignment", null)
                        .WithMany()
                        .HasForeignKey("AssignmentsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ITMO.Dev.ASAP.Core.Queue.Filters.AssignmentGroupFilter", null)
                        .WithMany()
            ...
            modelBuilder.Entity("GroupQueueFilterStudentGroup", b =>
                {
                    b.HasOne("ITMO.Dev.ASAP.Core.Queue.Filters.GroupQueueFilter", null)
                        .WithMany()
                        .HasForeignKey("FiltersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ITMO.Dev.ASAP.Core.Study.StudentGroup", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ITMO.Dev.ASAP.Core.Queue.Evaluators.SubmissionEvaluator", b =>
                {
                    b.HasOne("ITMO.Dev.ASAP.Core.Queue.SubmissionQueue", null)
                        .WithMany("Evaluators")
            ...
            modelBuilder.Entity("ITMO.Dev.ASAP.Core.Study.SubjectCourseGroup", b =>
                {
                    b.HasOne("ITMO.Dev.ASAP.Core.Queue.SubmissionQueue", "Queue")
                        .WithMany()
